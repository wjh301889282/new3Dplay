...
export default class UI {
	...
	constructor() {
		...
		this.doms = {
			...
			boards_htp: document.querySelector(".niceButton5")!,
	...
	showBoardsBox(title: string, author: string, describe: string,htp :string,img_src: string) {
		...
		this.doms.boards_htp.onclick = function (){
			window.open(htp);
		};
	...
	//	this.doms.boards_htp.textContent="";
